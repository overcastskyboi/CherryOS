        ...
        function getGroupedComments(comments) {
            ...
            for (const comment of comments) {
                if (comment.type === 'Block') {
                    ...
                    areAdjacentLineComments((0, index_js_1.last)(currentGroup), comment)) {
                            ...
                            suggest: [
                                {
                                    ...
                                    fix(fixer) {
                                        ...
                                        const end = (0, index_js_1.last)(groupComment.nodes).range[1];
...
function getCommentLocation(nodes) {
    return {
        ...
        end: (0, index_js_1.last)(nodes).loc.end,
    };
}
