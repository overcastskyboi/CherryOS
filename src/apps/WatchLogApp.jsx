...
import { Clapperboard, ArrowLeft, RefreshCcw, Star, Search, ExternalLink } from 'lucide-react';
    ...
    const query = `
      query ($userId: Int) {
        MediaListCollection(userId: $userId, type: ANIME) {
          lists { entries { media { id title { english romaji } coverImage { extraLarge } averageScore type status } score(format: POINT_10) progress status } }
        }
      ...
      <header className="glass-header sticky top-0 z-40 px-6 py-6 flex items-center justify-between">
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-[9px] text-gray-500 uppercase tracking-[0.4em] font-bold mt-1">Satellite // Engine Active</p>
          </div>
        </div>
